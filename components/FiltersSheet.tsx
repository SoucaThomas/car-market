      ...
      try {
        ...
        if (params) {
          setLocalFilters({
            ...
            carBrand: params.carBrand ? { id: -1, label: params.carBrand } : null,
            carModel: params.carModel ? { id: 0, label: params.carModel } : null,
            ...
            country: params.country
              ? {
                  ...
                  label: countries.find((c) => c.id === Number(params.country))?.label || '',
                }
              : null,
            fuelType: params.fuelType
              ? {
                  id: Number(params.fuelType),
                  label: fuel.find((f) => f.id === Number(params.fuelType))?.label || '',
                }
              : null,
            ...
            color: params.color
              ? {
                  ...
                  label: colors.find((c) => c.id === Number(params.color))?.label || '',
                }
              : null,
          });
        ...
        <div className="mt-5 flex flex-col gap-5">
          <div className="flex flex-row gap-4">
            <Button
              ...
              onClick={() => updateLocalFilter('carType', localFilters.carType === 0 ? null : 0)}
            >
              All Cars
            </Button>
            <Button
              variant={localFilters.carType === 1 ? 'default' : 'outline'}
              onClick={() => updateLocalFilter('carType', localFilters.carType === 1 ? null : 1)}
            >
              Used
            </Button>
            <Button
              variant={localFilters.carType === 2 ? 'default' : 'outline'}
              onClick={() => updateLocalFilter('carType', localFilters.carType === 2 ? null : 2)}
            >
              New
            </Button>
          </div>
          ...
          <FilterInput
            ...
            loading={loading && localFilters.carBrand !== null && carModels.length === 0}
          />
